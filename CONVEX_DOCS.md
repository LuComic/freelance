Use this as a Convex documentation index. First curl https://www.convex.dev/llms.txt. For any relative doc path beginning with "/", resolve it against https://docs.convex.dev before curling it. For example, /functions/actions.md means https://docs.convex.dev/functions/actions.md.
