...
export const LandingFeatureCard = ({
  ...
  return (
    <div
      className={`group overflow-hidden rounded-2xl border border-(--gray) bg-linear-to-b ${accent} p-5 transition hover:bg-(--darkest-hover)`}
    >
      ...
      <div className="mt-5 flex items-center justify-between">
        ...
        <span className="text-sm font-medium text-(--light) transition group-hover:translate-x-0.5">
          Learn more
        </span>
      </div>
    </div>
